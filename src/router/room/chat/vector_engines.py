...
class VectorStoreAndQueryEngine:
    ...
    def initialize_vector_query_engine(self, index, model="gpt-4", temperature=0.1, similarity_top_k=5):
        ...
        "The generated answer must always be in Japanese.\n"
        ...
        response_synthesizer = get_response_synthesizer(service_context=service_context, streaming=True,use_async=True)
